...
const Home = () => {
 ...
 const [login, setLogin] = useState({ email: "demouser@demo.com", password: "123" });
      ...
      <div className="flex w-screen h-screen  home justify-center lg:justify-normal">
        <div className="w-4/6 h-full lg:pt-40 pt-20 bg-opacity-50 flex items-center flex-col ">
          <div className="mt-40 flex items-left flex-col">
            ...
            <div className="flex items-left justify-left mt-5 lg:ml-10">
              ...
              {!authUser ? (
                <Button onClick={handleSubmit} variant="outlined">Try a Demo</Button>
              ) : (
